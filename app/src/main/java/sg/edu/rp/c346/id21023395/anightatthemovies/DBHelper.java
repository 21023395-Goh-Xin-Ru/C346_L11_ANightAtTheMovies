...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<Movie> getMoviesPG13(String PG13) {
        ArrayList<Movie> movies = new ArrayList<Movie>();
        SQLiteDatabase db = this.getReadableDatabase();
        String[] columns = {COLUMN_ID, COLUMN_TITLE, COLUMN_GENRE, COLUMN_YEAR, COLUMN_RATING};
        String condition = COLUMN_RATING + " = ?";
        String[] args = { String.format("%s", PG13)};
        Cursor cursor = db.query(TABLE_MOVIE, columns, condition, args, null, null, null);
    ...
    public ArrayList<Movie> getMoviesByRatings(String Rating) {
        ArrayList<Movie> movies = new ArrayList<Movie>();
        SQLiteDatabase db = this.getReadableDatabase();
        String[] columns = {COLUMN_ID, COLUMN_TITLE, COLUMN_GENRE, COLUMN_YEAR, COLUMN_RATING};
        String condition = COLUMN_RATING + " = ?";
        String[] args = { String.format("%s",Rating)};
        Cursor cursor = db.query(TABLE_MOVIE, columns, condition, args, null, null, null);
